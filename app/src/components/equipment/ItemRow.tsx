...
export default function ItemRow({ item }: Props) {
  ...
  return (
    <tr className="text-sm hover:bg-accent/[0.04] transition-colors group">
      <td className="py-1.5 px-3 border border-border" style={isUserAdded ? { borderLeft: '3px solid #58a6ff' } : {}}>
